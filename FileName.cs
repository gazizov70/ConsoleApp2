...
namespace Gazizov
{
    ...
    namespace AirplaneProject
    {
        ...
        public class PassengerAirplane : Airplane
        {
            ...
            new public void CheckEngine()
            {
                Console.WriteLine("Проверка двигателей пассажирского самолета...");
            }

            new public void UpdateMaintenanceLog()
            {
                Console.WriteLine("У пассажирского самолёта обновлён журнал");
            }
        }
    }
}
